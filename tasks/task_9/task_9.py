...
class QuizManager:
    ...
    def next_question_index(self, direction=1):
        ...
        if "question_index" in st.session_state:
            current_index = st.session_state.get("question_index")
            next_index = (current_index+direction) % self.total_questions
...
if __name__ == "__main__":
    ...
    if question_bank:
        ...
        with st.container():
            ...
            # Task 9
            quiz_manager = QuizManager(questions=question_bank)# Use our new QuizManager class
