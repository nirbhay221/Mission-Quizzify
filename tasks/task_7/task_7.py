...
class QuizGenerator:
    ...
    def generate_question_with_vectorstore(self):
        ...
        if self.llm is None or self.vectorstore is None:
            raise ValueError("LLM or VectorStore is not provided.")
        ...
        promptTemplate = PromptTemplate.from_template(self.system_template)
        ...
        chain = setup_and_retrieval | promptTemplate | self.llm 
